...
class Trainer:
    ...
    """
    def __init__(self, model, dataset, optim, num_epochs=20, batch_size=20, learning_rate=1e-2, learning_rate_decay=1.0):
        """
    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_indices in batches_indices:
                # TODO: Generate batches based on batch_indices and use model to generate loss and gradients for all the params
                ...
                for param_name, param in self.model.params().items():
                    ...
                    param.value = optimizer.update(param.value, param.grad, current_learning_rate)
            ...
            print("Loss: %f, Train accuracy: %f, val accuracy: %f" % (ave_loss, train_accuracy, val_accuracy))
